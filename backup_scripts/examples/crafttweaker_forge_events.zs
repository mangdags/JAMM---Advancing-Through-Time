...
CTEventManager.register<crafttweaker.api.event.entity.player.PlayerLoggedInEvent>((event) => {
    ...
    var message = new TextComponent("You can disable them by ") + new TextComponent("deleting")
    .setStyle(<constant:formatting:red>) + new TextComponent(" the ./scripts/examples folder!");
